...
namespace HotelAppLibrary.Data
{
    public class SqliteData : IDatabaseData
    {
        ...
        {
            // yeyeye SQLite is not supporting if not statements
            ...
            string sql = @"select 1 from Guests where FirstName = @firstName and LastName = @lastName LIMIT 1";
            var sqlFinal = _db.LoadData<dynamic,dynamic>(sql,
        ...
        public List<BookingFullModel> SearchBookings(string lastName)
        {
            string sql = @"select [b].[Id], [b].[RoomId], [b].[GuestId], [b].[StartDate], [b].[EndDate], [b].[CheckedIn], [b].[TotalCost], 
		                [g].[FirstName], [g].[LastName], [r].[RoomNumber], 
